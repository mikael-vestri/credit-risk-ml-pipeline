...
class ArtifactRegistry:
    ...
    def register_model(
        ...
        self._registry["models"][model_name].sort(key=lambda x: x["registered_at"], reverse=True)
    ...
    def update_training_run(self, run_id: str, results: dict[str, Any], completed: bool = True):
